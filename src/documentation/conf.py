...
project = "the Verification of Inflation using Airbnb data"
copyright = "2020, Burak Balaban"
...
latex_documents = [
    (
        ...
        """Documentation of the Verification of Inflation using Airbnb data project""",
        "Burak Balaban",
        "manual",
    )
]
